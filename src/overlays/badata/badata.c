...
void func_808006AC_badata(PlayerState *self , BaData_1 *arg1, enum asset_e *assetId, f32 *duration) {
    s32 tmp_v0 = func_80800000_badata(self);
    *assetId = arg1[tmp_v0].unk2;
    *duration = arg1[tmp_v0].unk4;
}


void badata_entrypoint_0(PlayerState *self, enum asset_e *assetId, f32 *arg2) {
    func_808006AC_badata(self, D_80801EF8_badata, assetId, arg2);
}

void badata_entrypoint_1(PlayerState *self, enum asset_e *assetId, f32 *arg2) {
    func_808006AC_badata(self, D_80801A78_badata, assetId, arg2);
}

void badata_entrypoint_2(PlayerState *self, enum asset_e *assetId, f32 *arg2) {
    func_808006AC_badata(self, D_80801B98_badata, assetId, arg2);
}

void badata_entrypoint_3(PlayerState *self, enum asset_e *assetId, f32 *arg2) {
    func_808006AC_badata(self, D_80801DD8_badata, assetId, arg2);
}

void badata_entrypoint_4(PlayerState *self, enum asset_e *assetId, f32 *arg2) {
    func_808006AC_badata(self, D_80802018_badata, assetId, arg2);
}

void badata_entrypoint_5(PlayerState *self, enum asset_e *assetId, f32 *arg2) {
...
void badata_entrypoint_7(PlayerState * self, enum asset_e *assetId, f32 *arg2) {
...
void badata_entrypoint_9(PlayerState *self, enum asset_e *assetId, f32 *duration) {
    func_808006AC_badata(self, D_80802138_badata, assetId, duration);
}

void badata_entrypoint_10(PlayerState *self, enum asset_e *assetId, f32 *arg2) {
    func_808006AC_badata(self, D_80802378_badata, assetId, arg2);
}

void badata_entrypoint_11(PlayerState *self, enum asset_e *assetId, f32 *arg2) {
