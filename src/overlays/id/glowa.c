...
#pragma GLOBAL_ASM("asm/nonmatchings/overlays/id/glowa/idglowa_entrypoint_0.s")

#pragma GLOBAL_ASM("asm/nonmatchings/overlays/id/glowa/idglowa_entrypoint_1.s")
