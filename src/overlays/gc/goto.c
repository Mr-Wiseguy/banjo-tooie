...
#pragma GLOBAL_ASM("asm/nonmatchings/overlays/gc/goto/func_8080011C_gcgoto.s")

#pragma GLOBAL_ASM("asm/nonmatchings/overlays/gc/goto/gcgoto_entrypoint_1.s")
...
#pragma GLOBAL_ASM("asm/nonmatchings/overlays/gc/goto/gcgoto_entrypoint_11.s")
