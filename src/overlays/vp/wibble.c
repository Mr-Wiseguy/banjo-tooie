...
#pragma GLOBAL_ASM("asm/nonmatchings/overlays/vp/wibble/func_808000B0_vpwibble.s")
...
#pragma GLOBAL_ASM("asm/nonmatchings/overlays/vp/wibble/vpwibble_entrypoint_3.s")
